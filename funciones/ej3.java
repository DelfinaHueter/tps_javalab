...
**Instrucciones**:
- Crea un arreglo `clientes` que almacene los nombres de los clientes y un arreglo `facturasPendientes`
con el monto de sus facturas pendientes.
...
public class ej3 {
    ...
    public static void llenarClientesFacturas(String[] clientes,int[] facturasPendientes) {
        ...
        for (int i = 0; i < clientes.length; i++) {
            ...
            System.out.println("Ingrese la factura del cliente");
    ...
    public static void enviarFacturas(String[] clientes,int[] facturasPendientes) {
        ...
        for (int i = 0; i < facturasPendientes.length; i++) {
            ...
            if (facturasPendientes[i] > 500){
                ...
                System.out.printf("La factura del empleado %s es mayor a $500\n",clientes[i]);
